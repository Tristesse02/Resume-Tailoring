...
# new_obj = input_json.copy()
# tmp = []
# for exp_obj in input_json["resume_data"]["personal_projects"]:
#     obj_pass_gpt = {}
#     obj_pass_gpt["title"] = exp_obj["title"]
#     obj_pass_gpt["description"] = (
#         f"{exp_obj['type']};Tech Stack: {', '.join(exp_obj['techStack'])};Description: {exp_obj['description']};Quantifiable Metrics: {exp_obj['quantifiableMetrics']};Bullet Points: {exp_obj['bulletPoints']}"
#     )
#     tmp.append(obj_pass_gpt)
# new_obj["resume_data"]["personal_projects"] = tmp

# tmp = []
# for exp_obj in input_json["resume_data"]["work_experiences"]:
#     obj_pass_gpt = {}
#     obj_pass_gpt["title"] = exp_obj["title"]
#     obj_pass_gpt["description"] = (
#         f"{exp_obj['type']};Tech Stack: {', '.join(exp_obj['techStack'])};Description: {exp_obj['description']};Quantifiable Metrics: {exp_obj['quantifiableMetrics']};Bullet Points: {exp_obj['bulletPoints']}"
#     )
#     tmp.append(obj_pass_gpt)
# new_obj["resume_data"]["work_experiences"] = tmp
