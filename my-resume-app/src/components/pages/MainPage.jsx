      ...
      <Card className="mainPage__CardStyle">
        <div className={styles.cardHeader}>
            ...
            <div className={styles.cardDescription}>
              Our AI-powered tool helps you customize your resume to match job descriptions
            </div>
        </div>
        <CardContent className="mainPage__CardContent">
            <div className={styles.cardsWrapper}>
              ...
              <div className={styles.stepCard}>
                ...
                <p className={styles.stepDescription}>Fill in your profile and education information</p>
              </div>
              ...
              <div className={styles.stepCard}>
                ...
                <p className={styles.stepDescription}>Input your work history and projects</p>
              </div>
              ...
              <div className={styles.stepCard}>
                ...
                <p className={styles.stepDescription}>Receive a tailored resume optimized for your target job</p>
              </div>
            </div>
